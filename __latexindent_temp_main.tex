...
\begin{table}[h!]
    ...
    \label{tab:rehabilitacion_robotica}
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|l|c|p{3cm}|p{6cm}|}
            \hline
...
\begin{itemize}
    \item Artículo JCR en relación con la implementación de la arquitectura de control en el sistema REHAP.

...
\begin{itemize}
    ...
    \item Desarrollar un algoritmo de gobernador de trayectoria que gestione explícitamente las restricciones cinemáticas y dinámicas del sistema, que mantengan al sistema siempre dentro de los límites de seguridad fisiológica del usuario.
...
\begin{itemize}
    \item Artículo JCR en relación a la implementación de un agente IA en el sistema REHAP.
    \item Artículo JCR en relación a la validación del sistema REHAP en sujetos sanos.
\end{itemize}

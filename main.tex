...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[>=latex, thick, font=\small]
        ...
        (gov) at (2.9,0) {Governador\\referencia};
...
\begin{itemize}
    \item \textbf{Objetivos terapéuticos}: definen la referencia de movimiento $r(t)$ a seguir por el dispositivo.
...
En conjunto, el modelado dinámico, el control backstepping, el observador de estados y el gobernador de referencia ---integrados bajo la arquitectura en cascada--- constituyen los pilares del sistema propuesto, permitiendo un dispositivo de rehabilitación clínicamente seguro, robusto y adaptativamente eficiente.
